...
public class SmscApi {
    ...
    private static String SMSC_LOGIN = "login";     // логин клиента
    private static String SMSC_PASSWORD = "password";  // пароль
    private static boolean SMSC_HTTPS = false;         // использовать HTTPS протокол
    private static String SMSC_CHARSET = "utf-8";       // кодировка сообщения: koi8-r, windows-1251 или utf-8 (по умолчанию)
    private static boolean SMSC_DEBUG = false;         // флаг отладки
    private static boolean SMSC_POST = false;         // Использовать метод POST
